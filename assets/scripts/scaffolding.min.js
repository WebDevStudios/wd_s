'use strict';window.wdsScaffolding = {}, ( function( window, $, app ) {
app.init = function() {
app.cache(), app.meetsRequirements() && app.bindEvents();
}, app.cache = function() {
app.$c = {window: $( window ), scaffoldingButton: $( '.scaffolding-button' ), scaffoldingContent: $( '.scaffolding-document-content' )};
