...
<form method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label for="search-field-<?php echo esc_attr( $wd_s_random_identifier ); ?>">
		...
		<input class="search-field" id="search-field-<?php echo esc_attr( $wd_s_random_identifier ); ?>" type="text" name="s" value="<?php echo get_search_query(); ?>" aria-required="false" autocomplete="off" placeholder="<?php echo esc_attr_e( 'Search', 'wd_s' ); ?>" />
	</label>
