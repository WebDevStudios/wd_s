...
function print_footer_block() {
    ...
    <div class="wp-block-group alignwide">
        ...
        <p class="has-text-align-center has-small-font-size" style="margin-top:var(--wp--preset--spacing--20);margin-bottom:0;padding-top:0;padding-bottom:0">$wds_copyright_info</p>
        <!-- /wp:paragraph -->

        <!-- wp:paragraph {"align":"center","style":{"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"var:preset|spacing|20","bottom":"0"}}},"fontSize":"small"} -->
        <p class="has-text-align-center has-small-font-size" style="margin-top:var(--wp--preset--spacing--20);margin-bottom:0;padding-top:0;padding-bottom:0">$wds_theme_info</p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    HTML;
	...
	$wds_block_footer = do_blocks( $wds_footer_content );

	return $wds_block_footer;
}
