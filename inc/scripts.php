...
function _s_scripts() {
	...
	wp_enqueue_script( '_s-scripts', get_template_directory_uri() . '/assets/dist/js/project' . $suffix . '.js', array( 'jquery' ), $version, true );
	...
	if ( is_page_template( 'template-scaffolding.php' ) ) {
		wp_enqueue_script( '_s-scaffolding', get_template_directory_uri() . '/assets/dist/js/scaffolding' . $suffix . '.js', array( 'jquery' ), $version, true );
	}
}
...
function _s_customizer_scripts() {
	...
	wp_enqueue_script( '_s_customizer', get_template_directory_uri() . '/assets/dist/js/customizer' . $suffix . '.js', array( 'jquery' ), $version, true );
}
...
function _s_include_svg_icons() {
	...
	$svg_icons = get_template_directory() . '/assets/dist/images/svg-icons.svg';
