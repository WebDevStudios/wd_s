...
app.cache = function () {
  app.$c = {
    ...
    headerSearchForm: jQuery__WEBPACK_IMPORTED_MODULE_0___default()('.site-header-action .cta-button')
  };
}; // Combine all events
...
app.hideSearchForm = function (event) {
  if (!jQuery__WEBPACK_IMPORTED_MODULE_0___default()(event.target).parents('div').hasClass('site-header-action')) {
    app.$c.body.removeClass('search-form-visible');
  }
}; // Engage


jQuery__WEBPACK_IMPORTED_MODULE_0___default()(app.init);
