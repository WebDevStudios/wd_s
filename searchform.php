...
<form method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label for="search-field-<?php echo esc_attr( $wd_s_random_identifier ); ?>">
		<span class="screen-reader-text"><?php esc_html_e( 'To search this site, enter a search term', 'wd_s' ); ?></span>
		<input class="search-field" id="search-field-<?php echo esc_attr( $wd_s_random_identifier ); ?>" type="search" name="s" value="<?php echo get_search_query(); ?>" aria-required="false" autocomplete="off" placeholder="<?php echo esc_attr_e( 'Search', 'wd_s' ); ?>" />
	</label>
